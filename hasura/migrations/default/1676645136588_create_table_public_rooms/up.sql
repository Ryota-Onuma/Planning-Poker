...
CREATE TABLE "public"."rooms" ("id" text NOT NULL, "name" text NOT NULL, "is_cards_open" boolean NOT NULL DEFAULT false, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") );
...
CREATE TRIGGER generate_id_trigger BEFORE INSERT ON "public"."rooms" FOR EACH ROW
